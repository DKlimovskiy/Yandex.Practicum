...
### 8. [*Прототип модели машинного обучения для промышленного предприятия*](https://github.com/DKlimovskiy/Yandex.Practicum/tree/main/Проект%208%20Прототип%20модели%20машинного%20обучения%20для%20промышленного%20предприятия)
**Описание проекта:**
